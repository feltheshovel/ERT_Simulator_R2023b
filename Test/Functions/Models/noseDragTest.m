classdef noseDragTest < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function testConeMode(testCase)
            % Test with cone mode on, and same settings as previous test
            % (nonzero angle of attack, subsonic velocity)
            rocket = testCase.TestRocket;
            rocket.coneMode = 'on';
            angleOfAttack = deg2rad(10); % 10 degrees [rad]
            freestreamVelocity = 80; % [m/s], subsonic
